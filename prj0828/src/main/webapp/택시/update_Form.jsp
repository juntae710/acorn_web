...
<%@  page import="java.sql.*" %>
	...
	try{ 
		...
		st = con.createStatement();
		 //4. 필요한 sql 작성
		String sql ="select REGNO,REGTIME,to_char(RDDATE, 'yyyy-mm-dd'),CUSNO,STARTPOINT,DESTINATION,TAXINO,STATE from tblcall_list where regno= '"+ regno + "'"; 
		 //5. 최종적으로 실행
